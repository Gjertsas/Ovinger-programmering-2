...
1. Lag en zip-fil av prosjektmappen din (slik som du gjorde i Mappe – Del 1) og legg ved som svar på denne oppgaven.
2. Push de siste endringene til remote repository og lim inn URL'en til ditt remote repo i tekstfeltet for innleveringen.
3. Vis frem det du har gjort til en læringsassistent for godkjenning
